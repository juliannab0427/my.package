...
5. Learn how to effectively plot and visualize data (know what to do and what not to do!)
...
### GitHub REPOSITORY:
The course GitHub repository is located at: https://github.com/wevanjohnson/2025_Spring_FDS. This page will contain all information in this syllabus, as well as the homework assignments and lecture slides. You should visit it regularly, as it will be updated frequently with new homework assignments and the upcoming week's lecture slides.
